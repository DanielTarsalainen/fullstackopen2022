  ...
  return (
    <div>
      ...
      <form onSubmit={addBlog}>
        <div>
          title:
          <input value={newBlog.title} onChange={onTitleChange}></input>
        </div>
        <div>
          author:
          <input value={newBlog.author} onChange={onAuthorChange}></input>
        </div>
        <div>
          url:
          <input value={newBlog.url} onChange={onUrlChange}></input>
        </div>
